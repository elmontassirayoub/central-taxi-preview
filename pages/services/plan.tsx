...
const Plan = ({ admin }: { admin: boolean }) => {
    return (
        <PageLayout page="/services/plan" admin={admin}>
            <SEO title="Découvrez le Plan du site de Central Taxi 67 - Strasbourg" description="Trouvez instantanément les informations que vous recherchez sur notre plateforme de Taxi Strasbourg Service, grâce à ce plan de site" />
            <PlanLayout />
        </PageLayout>
    )
}
