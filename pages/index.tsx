  ...
  return (
    <>
      ...
      <PageLayout lang={lang} changeLanguage={changeLanguage} page="/" admin={admin} >
        <section className="flex-1 section z-1 flex flex-col gap-10">
          ...
          <div className="px-[10%] text-center">
            <p className="font-meduim title lg:mb-7 mb-3">{pageData.home.section1.title}</p>
          ...
          <div className="flex flex-col gap-10 py-[50px] px-10">
          ...
          <div className="px-[10%] text-center">
            <p className="font-meduim title lg:mb-7 mb-5">{pageData.home.services.title}</p>
          ...
          <section className="pb-[100px]">
            <p className="mb-10 lg:mb-0 uppercase text-[24px] lg:text-[40px] lg:[word-spacing:5px] font-meduim text-center">{pageData.home.news}</p>
            ...
            <div className="px-[10%] text-center">
            <p className="font-meduim title lg:mb-7 mb-5">{pageData.home.vehicules.title}</p>
            <div className="lg:grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
              {
        ...
        <section className="py-20 px-10 lg:px-20 lg:py-[100px] section">
          <p className="mb-2 lg:mb-0 uppercase text-[24px] lg:text-[40px] lg:[word-spacing:5px] font-meduim text-center">{pageData.home.reviews.h1}</p>
