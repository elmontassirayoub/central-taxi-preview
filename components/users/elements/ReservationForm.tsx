    ...
    return <>
        ...
        <div className="flex flex-col gap-3 w-full">
            <div className="flex flex-col gap-1 w-full">
                <label className="font-medium">{compData.signup.label1}</label>
            ...
            <div className="flex flex-col gap-1 w-full">
                <label className="font-medium text-[14px]">{compData.signup.label2}</label>
            ...
            <div className="flex flex-col gap-1 w-full">
                <label className="font-medium text-[14px]">{compData.signup.label3}</label>
            ...
            <div className="flex flex-col gap-1 w-full">
                <label className="font-medium text-[14px]">{compData.signup.label4}</label>
            ...
            <div className="flex flex-col gap-1 w-full">
                <label className="font-medium text-[14px]">{compData.signup.label5}</label>
