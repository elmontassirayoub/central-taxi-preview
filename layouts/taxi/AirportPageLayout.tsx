...
const AirportPageLayout: React.FC<{ subtitle?: string; pricingSubtitle?: string; benefitsSubtitle?: string }> = ({ subtitle, pricingSubtitle, benefitsSubtitle }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-100">
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-r from-purple-900 via-violet-800 to-purple-900 text-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <div className="space-y-6 lg:space-y-8 order-2 lg:order-1">
                            <div className="space-y-3 lg:space-y-4">
                                ...
                                <p className="text-lg sm:text-xl lg:text-2xl text-purple-100 font-light">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {activeTab === 0 && (
                        <div className="space-y-8 sm:space-y-12">
                            ...
                            {/* Train Stations */}
                            <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-4 sm:p-6 lg:p-8">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
                                    {pageData.sections[1]?.items.map((station, idx) => (
                                        <div key={idx} className="bg-white rounded-lg p-3 sm:p-4 text-center shadow-sm hover:shadow-md transition-shadow">
                                            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-2">
                                    ...
                                    return (
                                        <div key={idx} className="bg-white rounded-xl shadow-lg p-4 space-y-2">
                                            ...
                                            <div className="flex justify-between text-xs">
                                                ...
                                                <span className="font-semibold text-purple-600">{nightRate}</span>
                                            </div>
                                        </div>
                                    )
                                })}
                                        ...
                                        {pageData.sections[2]?.items.map((route, idx) => {
                                            ...
                                            return (
                                                <tr key={idx} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4 text-sm text-purple-600 font-semibold">{nightRate}</td>
                                                </tr>
                                            )
                                        })}
                                    </tbody>
            ...
            {/* CTA Section */}
            <section className="bg-gradient-to-r from-purple-900 to-violet-900 text-white py-12 sm:py-16">
