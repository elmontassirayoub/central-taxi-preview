import Data, { ParticulierOption, ParticulierType } from "@/assets/data/particulier"
...
const ParticulierLayout = () => {
    ...
    const pageData: ParticulierType = Data[lang]
        ...
        <div className="">
            ...
            <div className="lg:mx-[15%] mx-5 flex flex-col gap-4 pb-10">
                ...
                <div className="text-[#000]/[85%] text-sm grid lg:grid-cols-2 gap-3">
                    {pageData?.options?.map((op: ParticulierOption, idx: number) => <div className="p-3 rounded-[8px] border-[1px] border-[#000]/[50%] flex flex-col gap-2" key={idx}>
                        <p className="text-base font-semibold">{op?.title}</p>
                        <p className="text-xs text-[#000]/[50%]">{op?.description}</p>
                        <ul className="text-[#000]/[85%] text-sm ml-5">
